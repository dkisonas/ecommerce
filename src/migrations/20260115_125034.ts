...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_refund_requests_type" AS ENUM('full', 'partial');
  CREATE TYPE "public"."enum_refund_requests_currency" AS ENUM('GBP');
  CREATE TYPE "public"."enum_refund_requests_status" AS ENUM('pending', 'approved', 'rejected', 'cancelled');
  CREATE TYPE "public"."enum_refunds_currency" AS ENUM('GBP');
  CREATE TYPE "public"."enum_refunds_type" AS ENUM('full', 'partial');
  CREATE TYPE "public"."enum_refunds_status" AS ENUM('processing', 'completed', 'failed');
  ...
  CREATE TYPE "public"."enum_orders_status" AS ENUM('processing', 'completed', 'cancelled', 'refunded', 'refund_requested', 'partially_refunded');
  ...
  CREATE TYPE "public"."enum_header_nav_items_link_type" AS ENUM('category', 'page', 'custom');
  CREATE TYPE "public"."enum_footer_columns_links_link_type" AS ENUM('category', 'page', 'custom');
  CREATE TYPE "public"."enum_footer_social_links_platform" AS ENUM('facebook', 'instagram', 'twitter', 'tiktok', 'youtube', 'linkedin');
  CREATE TYPE "public"."enum_footer_nav_items_link_type" AS ENUM('category', 'page', 'custom');
  ...
  CREATE TABLE "refund_requests_items" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"product_id" integer,
  ...
  CREATE TABLE "refund_requests" (
  	...
  	"type" "enum_refund_requests_type" NOT NULL,
  	"amount" numeric,
  	"currency" "enum_refund_requests_currency" DEFAULT 'GBP' NOT NULL,
  ...
  CREATE TABLE "refunds" (
  	...
  	"currency" "enum_refunds_currency" DEFAULT 'GBP' NOT NULL,
  	"type" "enum_refunds_type" NOT NULL,
  	"status" "enum_refunds_status" DEFAULT 'processing' NOT NULL,
  ...
  CREATE TABLE "orders_admin_notes" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  ...
  CREATE TABLE "header_nav_items" (
  	...
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_header_nav_items_link_type" DEFAULT 'custom' NOT NULL,
  ...
  CREATE TABLE "footer_columns_links" (
  	...
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_footer_columns_links_link_type" DEFAULT 'custom' NOT NULL,
  	"link_new_tab" boolean,
  	"link_category_id" integer,
  	"link_page_id" integer,
  	"link_url" varchar,
  ...
  CREATE TABLE "settings" (
  	...
  	"form_submission_email" varchar,
  	"shipping_title" varchar DEFAULT 'Free shipping over £50',
  	"shipping_description" varchar DEFAULT 'Standard delivery 3-5 business days',
  	"returns_title" varchar DEFAULT 'Free 30-day returns',
  	"returns_description" varchar DEFAULT 'Hassle-free returns on all orders',
  	"payment_methods_stripe_enabled" boolean DEFAULT true,
  	"payment_methods_paysera_enabled" boolean DEFAULT false,
  	"payment_methods_neopay_enabled" boolean DEFAULT false,
  	"updated_at" timestamp(3) with time zone,
  	"created_at" timestamp(3) with time zone
  );
  ...
  ALTER TABLE "refund_requests_items" ADD CONSTRAINT "refund_requests_items_product_id_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."products"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "refund_requests_items" ADD CONSTRAINT "refund_requests_items_variant_id_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."variants"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "refund_requests_items" ADD CONSTRAINT "refund_requests_items_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."refund_requests"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "refund_requests" ADD CONSTRAINT "refund_requests_customer_id_users_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "refund_requests" ADD CONSTRAINT "refund_requests_rejected_by_id_users_id_fk" FOREIGN KEY ("rejected_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "refund_requests" ADD CONSTRAINT "refund_requests_approved_by_id_users_id_fk" FOREIGN KEY ("approved_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "refund_requests" ADD CONSTRAINT "refund_requests_refund_id_refunds_id_fk" FOREIGN KEY ("refund_id") REFERENCES "public"."refunds"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "refunds_items" ADD CONSTRAINT "refunds_items_variant_id_variants_id_fk" FOREIGN KEY ("variant_id") REFERENCES "public"."variants"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "refunds" ADD CONSTRAINT "refunds_transaction_id_transactions_id_fk" FOREIGN KEY ("transaction_id") REFERENCES "public"."transactions"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "refunds" ADD CONSTRAINT "refunds_refund_request_id_refund_requests_id_fk" FOREIGN KEY ("refund_request_id") REFERENCES "public"."refund_requests"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "orders_admin_notes" ADD CONSTRAINT "orders_admin_notes_added_by_id_users_id_fk" FOREIGN KEY ("added_by_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders_admin_notes" ADD CONSTRAINT "orders_admin_notes_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;
  ALTER TABLE "orders" ADD CONSTRAINT "orders_customer_id_users_id_fk" FOREIGN KEY ("customer_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "orders" ADD CONSTRAINT "orders_shipping_method_id_shipping_methods_id_fk" FOREIGN KEY ("shipping_method_id") REFERENCES "public"."shipping_methods"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "orders_rels" ADD CONSTRAINT "orders_rels_refunds_fk" FOREIGN KEY ("refunds_id") REFERENCES "public"."refunds"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "footer_columns_links" ADD CONSTRAINT "footer_columns_links_link_category_id_categories_id_fk" FOREIGN KEY ("link_category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ...
  ALTER TABLE "footer_nav_items" ADD CONSTRAINT "footer_nav_items_link_category_id_categories_id_fk" FOREIGN KEY ("link_category_id") REFERENCES "public"."categories"("id") ON DELETE set null ON UPDATE no action;
  ALTER TABLE "footer_nav_items" ADD CONSTRAINT "footer_nav_items_link_page_id_pages_id_fk" FOREIGN KEY ("link_page_id") REFERENCES "public"."pages"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "refund_requests_items_order_idx" ON "refund_requests_items" USING btree ("_order");
  CREATE INDEX "refund_requests_items_parent_id_idx" ON "refund_requests_items" USING btree ("_parent_id");
  CREATE INDEX "refund_requests_items_product_idx" ON "refund_requests_items" USING btree ("product_id");
  CREATE INDEX "refund_requests_items_variant_idx" ON "refund_requests_items" USING btree ("variant_id");
  CREATE INDEX "refund_requests_order_idx" ON "refund_requests" USING btree ("order_id");
  CREATE INDEX "refund_requests_customer_idx" ON "refund_requests" USING btree ("customer_id");
  CREATE INDEX "refund_requests_rejected_by_idx" ON "refund_requests" USING btree ("rejected_by_id");
  CREATE INDEX "refund_requests_approved_by_idx" ON "refund_requests" USING btree ("approved_by_id");
  CREATE INDEX "refund_requests_refund_idx" ON "refund_requests" USING btree ("refund_id");
  CREATE INDEX "refund_requests_updated_at_idx" ON "refund_requests" USING btree ("updated_at");
  ...
  CREATE INDEX "refunds_items_variant_idx" ON "refunds_items" USING btree ("variant_id");
  CREATE INDEX "refunds_order_idx" ON "refunds" USING btree ("order_id");
  CREATE INDEX "refunds_transaction_idx" ON "refunds" USING btree ("transaction_id");
  CREATE INDEX "refunds_processed_by_idx" ON "refunds" USING btree ("processed_by_id");
  CREATE INDEX "refunds_refund_request_idx" ON "refunds" USING btree ("refund_request_id");
  ...
  CREATE INDEX "orders_admin_notes_order_idx" ON "orders_admin_notes" USING btree ("_order");
  CREATE INDEX "orders_admin_notes_parent_id_idx" ON "orders_admin_notes" USING btree ("_parent_id");
  CREATE INDEX "orders_admin_notes_added_by_idx" ON "orders_admin_notes" USING btree ("added_by_id");
  ...
  CREATE INDEX "orders_rels_refunds_id_idx" ON "orders_rels" USING btree ("refunds_id");
  ...
  CREATE INDEX "footer_columns_links_link_link_category_idx" ON "footer_columns_links" USING btree ("link_category_id");
  ...
  CREATE INDEX "footer_nav_items_link_link_category_idx" ON "footer_nav_items" USING btree ("link_category_id");
  CREATE INDEX "footer_nav_items_link_link_page_idx" ON "footer_nav_items" USING btree ("link_page_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "refund_requests_items" CASCADE;
  DROP TABLE "refund_requests" CASCADE;
  ...
  DROP TABLE "orders_admin_notes" CASCADE;
  ...
  DROP TYPE "public"."enum_refund_requests_type";
  DROP TYPE "public"."enum_refund_requests_currency";
  DROP TYPE "public"."enum_refund_requests_status";
